...
#ifndef OMPL_CONTROL_PLANNERS_SST_UKSST_
#define OMPL_CONTROL_PLANNERS_SST_UKSST_
...
namespace ompl
{
    ...
    {
        /**
           @anchor cUncertainKinodynamicPlanner
           @par Short description
           \ref cUncertainKinodynamicPlanner "UncertainKinodynamicPlanner" (Stable Sparse RRT) is a asymptotically near-optimal incremental
        ...
        */
        ...
        public:
            /** \brief Constructor */
            UncertainKinodynamicPlanner(const SpaceInformationPtr &si);
